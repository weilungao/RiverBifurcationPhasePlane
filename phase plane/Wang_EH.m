...
xlabel('{\it D}_1 (m)','FontSize', FontSize); 
ylabel('{\it D}_2 (m)','FontSize', FontSize);
box on
FontSize1=15;
% legend([h1, h2], 'd{\it D}_1/d{\it t}=0', 'd{\it D}_2/d{\it t}=0','FontSize', FontSize1, 'FontName', 'Times New Roman');

fig_name=strcat('Wang_EH_k=', num2str(k), '.tif');
